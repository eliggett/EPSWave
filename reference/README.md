...
[eps_16plus_full_midi_implementation.md](eps_16plus_full_midi_implementation.md) : This markdown is generally better -- but not always -- and does not contain any embedded image data. Some tables have been edited for clarity, others still need a little help. 
